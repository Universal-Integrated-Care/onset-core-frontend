...
var prisma = require("@/lib/prisma").default;
var clinicsData = require("@/test_data/clinics.json");
var patientsData = require("@/test_data/patients.json");
var practitionersData = require("@/test_data/practitioners.json");
var availabilityData = require("@/test_data/practitioner_avaialbitlity.json");
var usersData = require("@/test_data/users.json");
var bcrypt = require("bcrypt");
var _a = require("@prisma/client"), clinictype = _a.clinictype, dayofweek = _a.dayofweek, patienttype = _a.patienttype, practitionertype = _a.practitionertype, specialization = _a.specialization;
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    ...
                    _i = 0, _a = clinicsData.clinics;
                    _j.label = 1;
                case 1:
                    if (!(_i < _a.length)) return [3 /*break*/, 4];
                    clinic = _a[_i];
                    return [4 /*yield*/, prisma.clinics.create({
                            data: {
                                name: clinic.name,
                                ...
                                clinic_type: clinic.clinic_type.map(function (type) {
                                    return validateEnum(type, clinictype);
                                }),
                                days_opened: clinic.days_opened.map(function (day) {
                                    return validateEnum(day, dayofweek);
                                }),
                            },
                        })];
                case 2:
                ...
                case 8:
                    ...
                    _d = 0, _e = practitionersData.practitioners;
                    _j.label = 9;
                case 9:
                    if (!(_d < _e.length)) return [3 /*break*/, 12];
                    practitioner = _e[_d];
                    return [4 /*yield*/, prisma.practitioners.create({
                            data: {
                                name: practitioner.name,
                                email: practitioner.email,
                                phone: practitioner.phone,
                                practitioner_type: validateEnum(practitioner.practitioner_type, practitionertype),
                                ...
                                specialization: practitioner.specialization.map(function (spec) {
                                    return validateEnum(spec, specialization);
                                }),
                            },
                        })];
                case 10:
                ...
                case 12:
                    ...
                    _f = 0, availabilityData_1 = availabilityData;
                    _j.label = 13;
                case 13:
                    if (!(_f < availabilityData_1.length)) return [3 /*break*/, 16];
                    slot = availabilityData_1[_f];
                    return [4 /*yield*/, prisma.practitioner_availability.create({
                            data: {
